...
.news-ceil{ border-bottom: 1px solid #d9d9d9;padding: 15px 0;overflow: hidden;text-align: left;}
.news-ceil:hover{background: #f2f2f2;}
.news-ceil dt{width: 204px;height: 150px;float: left;}
.news-ceil dt img{width: 100%;height: 100%;border: 1px solid #d9d9d9;}
.news-ceil dd{width: 740px; float: right;}
.news-ceil dd .news-abstract {height: 136px;overflow: hidden;}
.news-ceil dd .news-abstract a{font-size:20px ; line-height: 36px;font-weight: 500;color: #333;overflow: hidden;text-overflow: ellipsis;display: -webkit-box;-webkit-box-orient: vertical;-webkit-line-clamp: 2;}
.news-ceil dd .news-abstract a:hover{color: #1a89d9;}
.news-ceil dd .news-abstract .news-brief{  color: #656565;}
.news-ceil dd cite{font-style: normal;font-size:12px ;line-height: 12px;color: #999999;}
</style>
